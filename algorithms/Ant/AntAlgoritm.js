...
async function ACO(){
    let numberOfGeneration = document.getElementById("numberOfGeneration").value;
    ...
    for (let generation = 0; generation < numberOfGeneration; ++generation){
        if (end === 0){
            drawFinishPath(bestAnt[0]);
            break;
        }
